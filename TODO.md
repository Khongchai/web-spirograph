- Pause offloading stuff to instantdrawercycloidParams and make it work first cus I think we might need to offload the tracing to another canvas entirely.
