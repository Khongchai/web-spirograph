 ...
 */
abstract class SimpleIdGenerator {
  simpleSeed: string;
  count: number;
...
private canvasAndListenerCallbackMap: Record<string, VoidFunction | undefined> = {};
...
setCanvasSize(
  ...
  if (withResizeListener){
    ...
    this.canvasAndListenerCallbackMap[canvas.getAttribute(this.mainThreadCanvasAttributeName)!] = listenerCallback;
  }
}
...
export class CanvasSizeManagers {
    static mainThreadCanvasSizeManager  = new CanvasSizeManager("mainThreadCanvasSizeManager");
    static particlesWorkerCanvasSizeManager = new CanvasSizeManager("particlesWorkerCanvasSizeManager");
    static instantDrawerCanvasSizeManager = new CanvasSizeManager("instantDrawerCanvasSizeManager");
}
